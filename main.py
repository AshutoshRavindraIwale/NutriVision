...
# Assuming NutritionalEvaluator class is defined here or imported
...
# Allow users to select a product from the dataset
product_names = evaluator.data['Name of the Product'].tolist()
selected_product = st.selectbox('Select a Product:', product_names)

# Display the selected product's nutritional evaluation
if selected_product:
    product_data = evaluator.data[evaluator.data['Name of the Product'] == selected_product].iloc[0]
